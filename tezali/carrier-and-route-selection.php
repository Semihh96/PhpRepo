...
<head>
    ...
    <title>TEZALİ - Carrier And Route Selection</title>
...
<div class="breadcrumb-section"
     style="background-image: url(assets/img/inner-pages/banner-2.jpeg);">
    <div class="company-name">TEZALİ</div>
    <div class="container-fluid one pl--95">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-content">
                    <h1>Carrier And Route Selection</h1>
                    <ul class="breadcrumb-list">
                        <li><a href="http://tezali.co.uk/">Home</a></li>
                        <li>Carrier And Route Selection</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="service-details-wrapper pt-130 mb-130">
    <div class="container-fluid one pl--95">
        <div class="details-page-content mb-70">
            <h2>Carrier And Route Selection</h2>
            <div class="row g-lg-4 gy-2">
                <div class="col-lg-6">
                    <p class="first-para"> Goals are set for the benefit of both the company and the
                        individual and steps are taken to realize these goals through career plan development.
                        The career planning process is an important process to think about. In this process, the individual makes his/her own personal evaluation.
                        </p>
                </div>
                <div class="col-lg-6">
                    <p>At this stage, the individual should determine his/her own goals.
                        They should identify their personal skills, positive and negative aspects and determine a path accordingly.
                        Individuals are different and therefore not every career plan can be the same.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-md-4 gy-5">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="solution-content">
                        ...
                        <a class="primary-btn1 btn-hover" href="contact-us.php">
                            Get in Touch
        ...
        <div class="service-details-advantage">
