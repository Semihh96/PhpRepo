...
<head>
    ...
    <title>TEZALİ - Consultancy</title>
...
<body id="body" class="tt-smooth-scroll tt-magic-cursor">
    ...
    <div class="breadcrumb-section"
        style="background-image:  url(assets/img/inner-pages/banner.jpeg);">
        ...
        <div class="container-fluid one pl--95">
            <div class="details-page-content mb-70">
                ...
                <div class="row g-lg-4 gy-2">
                    <div class="col-lg-6">
                        <p class="first-para"> Our most important goal is to enable the companies we work with to 
                            solve their most challenging problems, develop their competencies and achieve better results.</p>
                    </div>
                    <div class="col-lg-6">
                        <p>Using  our knowledge and experience, we conduct deep research and analysis in the field of 
                            management and develop long-term creative solutions.</p>
                    </div>
                </div>
            </div>
