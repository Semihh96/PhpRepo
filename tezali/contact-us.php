...
<div class="breadcrumb-section"
     style="background-image:  url(assets/img/inner-pages/banner-3.jpg);">
        ...
        <div class="row g-lg-4 gy-5">
            <div class="col-lg-5">
                <div class="single-location mb-50">
                    <div class="title-and-view-btn">
                        ...
                        <a href="https://maps.app.goo.gl/PbGjb3GJZrKHK32q6" target="_blank">View Map
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="info">
                                <a href="tel:+4407394081630" target="_blank">+44 (0) 73 9408 1630</a>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 18 18">
                                    <path d="M0 4.5C0 3.90326 0.237053 3.33097 0.65901 2.90901C1.08097 2.48705 1.65326 2.25 2.25 2.25H15.75C16.3467 2.25 16.919 2.48705 17.341 2.90901C17.7629 3.33097 18 3.90326 18 4.5V13.5C18 14.0967 17.7629 14.669 17.341 15.091C16.919 15.5129 16.3467 15.75 15.75 15.75H2.25C1.65326 15.75 1.08097 15.5129 0.65901 15.091C0.237053 14.669 0 14.0967 0 13.5V4.5ZM2.25 3.375C1.95163 3.375 1.66548 3.49353 1.4545 3.7045C1.24353 3.91548 1.125 4.20163 1.125 4.5V4.74412L9 9.46912L16.875 4.74412V4.5C16.875 4.20163 16.7565 3.91548 16.5455 3.7045C16.3345 3.49353 16.0484 3.375 15.75 3.375H2.25ZM16.875 6.05587L11.5785 9.234L16.875 12.4931V6.05587ZM16.8368 13.7914L10.4918 9.8865L9 10.7809L7.50825 9.8865L1.16325 13.7903C1.22718 14.0296 1.36836 14.2412 1.56486 14.3922C1.76137 14.5431 2.00221 14.625 2.25 14.625H15.75C15.9976 14.625 16.2384 14.5434 16.4349 14.3926C16.6313 14.2419 16.7726 14.0306 16.8368 13.7914ZM1.125 12.4931L6.4215 9.234L1.125 6.05587V12.4931Z"></path>
                                </svg>
                            </div>
                            <div class="info">
                                <a href="mailto:info@tezali.co.uk" target="_blank">info@tezali.co.uk</a>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                            ...
                            <div class="info">
                                <a>85 Great Portland St, First Floor, London, W1W 7LT, United Kingdom</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-7">
                <div class="company-map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4965.468089793915!2d-0.14869698717509672!3d51.51809508882819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761ad5969a5555%3A0xdb69a017aa33b477!2sMy%20City%20Office!5e0!3m2!1str!2str!4v1706437460026!5m2!1str!2str" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
